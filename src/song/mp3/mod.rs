...
impl Header {
	...
	pub fn sync(self) -> bool {
		self[0] == 0xFF && self[1] & 0b11100000 == 0b11100000
	}
	...
	pub fn version(self) -> Version {
		match (self[1] >> 3) & 0b11 {
			...
			0b10 => Version::V2,
			0b00 => Version::V2_5,
			unk => unreachable!("Invalid version bit {:0b}", unk),
		}
	}
	...
	pub fn layer(self) -> Layer {
		match (self[1] >> 1) & 0b11 {
			...
			0b10 => Layer::L2,
			0b01 => Layer::L3,
			unk => unreachable!("Invalid layer bits {:0b}", unk),
		}
	}

	#[inline]
	pub fn bitrate(self) -> i64 {
		data::get_bitrate(self.version(), self.layer(), self[2] >> 4) * 1000
	}
